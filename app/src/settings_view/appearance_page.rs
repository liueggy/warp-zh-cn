...
use warp_localization::UiLanguage;
...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    app.register_fixed_bindings(
        [
            (
                "command-use-system-language",
                AppearancePageAction::SetLanguage(UiLanguage::System),
            ),
            (
                "command-use-english",
                AppearancePageAction::SetLanguage(UiLanguage::EnUs),
            ),
            (
                "command-use-simplified-chinese",
                AppearancePageAction::SetLanguage(UiLanguage::ZhCn),
            ),
        ]
        .map(|(message_id, action)| {
            FixedBinding::empty(
                localization::text(message_id, app),
